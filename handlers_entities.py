...
async def list_forms(ctx, params: ListFormsParams) -> ActionResult:
    ...
    return ActionResult.ok(FormList(forms=[_form_entity(f) for f in items]))
...
async def get_form(ctx, params: GetFormParams) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.error(exc.payload["message"], code=exc.payload["code"])
    return ActionResult.ok(FormDetail(
        id=f.get("id", ""), title=f.get("title", ""),
...
async def delete_form(ctx, params: DeleteFormParams) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.error(exc.payload["message"], code=exc.payload["code"])
    return ActionResult.ok(DeleteResult(deleted=True, id=params.form_id))
...
async def list_responses(ctx, params: ListResponsesParams) -> ActionResult:
    ...
    return ActionResult.ok(ResponseList(total_items=resp.get("total_items", 0) if isinstance(resp, dict) else 0, responses=responses))
...
async def delete_responses(ctx, params: DeleteResponsesParams) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.error(exc.payload["message"], code=exc.payload["code"])
    return ActionResult.ok(DeleteResult(deleted=True, id=",".join(params.response_ids)))
...
async def list_workspaces(ctx, params: ListWorkspacesParams) -> ActionResult:
    ...
    return ActionResult.ok(WorkspaceList(workspaces=workspaces))
...
async def create_workspace(ctx, params: CreateWorkspaceParams) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.error(exc.payload["message"], code=exc.payload["code"])
    return ActionResult.ok(WorkspaceCreateResult(id=w.get("id", ""), name=w.get("name", params.name)))
...
async def list_webhooks(ctx, params: ListWebhooksParams) -> ActionResult:
    ...
    return ActionResult.ok(WebhookList(webhooks=webhooks))
...
async def create_webhook(ctx, params: CreateWebhookParams) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.error(exc.payload["message"], code=exc.payload["code"])
    return ActionResult.ok(WebhookCreateResult(tag=w.get("tag", params.tag), url=w.get("url", params.url), enabled=w.get("enabled", params.enabled)))
...
async def delete_webhook(ctx, params: DeleteWebhookParams) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.error(exc.payload["message"], code=exc.payload["code"])
    return ActionResult.ok(DeleteResult(deleted=True, id=params.tag))
